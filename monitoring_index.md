...
As of 31 January 2020 Nimsoft Monitor is no longer available for purchase and free Nimsoft access is removed as {{site.data.keyword.cloud}} transitions to IBM Cloud Monitoring with Sysdig. For more information about Monitoring with Sysdig, see [IBM Cloud Monitoring with Sysdig](/docs/services/Monitoring-with-Sysdig?topic=Sysdig-about). For existing Nimsoft customers, Nimsoft support continues until 30 April 2020. Any Nimsoft instances that remain as of 30 April 2020 will be deleted. To continue monitoring after this date, you need to move to Sysdig. 
{: deprecated}
